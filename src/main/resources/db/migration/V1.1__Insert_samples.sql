...
values (1, current_timestamp, current_timestamp, '55', 'ACCEPTED', 999.00),
       (2, current_timestamp, current_timestamp, '66', 'ACCEPTED', 759.00),
       (4, current_timestamp, current_timestamp, '77', 'ACCEPTED', 759.00);

insert into "orders"
values
       (1, current_timestamp, current_timestamp, '1 Rue Vaugirard', '', 'Paris', 'FR', '75015', NULL, 'PAID',
        999.00, 1, 2),
...
--insert into "orders" (id, created_date, country, postcode, status, total_price)
--values
--       (1, current_timestamp, 'FR', '12345', 'PAID', 999.00),
--       (2, current_timestamp, 'FR', '12345', 'PAID', 999.00),
--       (3, current_timestamp, 'FR', '12345', 'PAID', 999.00),
--       (4, current_timestamp, 'FR', '12345', 'PAID', 999.00),
--       (5, current_timestamp, 'FR', '12345', 'PAID', 999.00);
